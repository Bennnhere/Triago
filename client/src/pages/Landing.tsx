...
export default function Landing() {
  return <div className="landing-shell"><EntranceOverlay /><header className="site-nav"><Link href="/" className="brand"><span className="brand-glyph"><i /><i /><i /></span><span>TRIAGO</span></Link><nav><a href="#product">Product</a><a href="#workflow">How It Works</a><a href="#features">Features</a><Link href="/app?section=incidents">Incidents</Link></nav><Link href="/app" className="nav-cta">Open Command Center <ArrowRight size={15} /></Link></header>
    <main>
      <section className="landing-hero" id="product"><div className="hero-copy"><div className="eyebrow-chip"><Radar size={14} /> AUTONOMOUS INCIDENT RESPONSE</div><h1>Your First Responder When <em>Production</em> Breaks.</h1><p>Triago autonomously investigates incidents, learns from past resolutions, and takes action — so small engineering teams can spend less time firefighting and more time building.</p><div className="hero-actions"><Link href="/app" className="button primary">Launch Triago <ArrowRight size={17} /></Link><a href="#workflow" className="button secondary">See How It Works <ChevronRight size={17} /></a></div><div className="hero-trust"><span><Check size={14} /> Investigates with evidence</span><span><Check size={14} /> Escalates safely when uncertain</span></div></div><MiniIncidentConsole /><div className="signal-translation" aria-label="Triago turns raw signals into a verified operational outcome"><div className="signal-intake"><span>RAW INTAKE</span><b>47 alerts</b><i /><i /><i /></div><div className="signal-aperture"><span>TRIAGE GATE</span><i /></div><div className="signal-output"><span>COMPOSED OUTPUT</span><b>1 verified incident</b><em>owner notified</em></div></div></section>
