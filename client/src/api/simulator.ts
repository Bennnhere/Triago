...
import type { AlertPayload, SimulatorScenario } from "./types";
...
export async function submitAlert(alert: AlertPayload): Promise<{ incident: { incident_id: number }; outcome: string; confidence: number }> {
