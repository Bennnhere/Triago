...
- [x] Save the final verified production-agent checkpoint and push the source revision to GitHub.
...
- [x] Redeploy the final wording update and confirm the public command center and simulator show no FastAPI-only labels.
